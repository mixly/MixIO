...
typedef enum  {
  ...
  EXEC_RUN_MASK = EXEC_YES|EXEC_BREAK|EXEC_CONTINUE|EXEC_INTERRUPTED|EXEC_EXCEPTION,   //0b11111
  ...
  EXEC_SAVE_RESTORE_MASK = EXEC_YES|EXEC_IN_LOOP|EXEC_IN_SWITCH | EXEC_ERROR_MASK, //0b11 0011 1001 // the things JSP_SAVE/RESTORE_EXECUTE should keep track of
